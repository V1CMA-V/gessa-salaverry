    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          name="name_analista"
          render={({ field }) => (
            <FormItem className="col-span-2 w-full flex flex-col items-center">
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Andre Mora Zempoalteca">
                    Andre Mora Zempoalteca
                  </SelectItem>
                  <SelectItem value="Montserrath Cuatepotzo">
                    Montserrath Cuatepotzo
                  </SelectItem>
                  <SelectItem value="Mariangel Gutierrez Coca">
                    Mariangel Gutierrez Coca
                  </SelectItem>
                </SelectContent>
              </Select>
              <FormMessage />
